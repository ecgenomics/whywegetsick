...
# Input data
traits <- read.csv("genetic-correlations-fertility-related-traits.txt",
                   sep="\t")
...
p <- ggplot(selected_traits, aes(x = GC, y = Name)) +
  ...
  labs(x = expression(paste("Genetic correlation (", italic(r)[g], ")"))) +
...
# Add text to figure
figure <- figure + annotate("text", x = 0.17, y = 0.98, label = "Biology of Reproduction:", 
                            color = "black", size = (7/.pt), family = "Helvetica", fontface = "bold")
figure <- figure + annotate("text", x = 0.17, y = 0.88, label = "Reproductive Behaviour:", 
                            color = "black", size = (7/.pt), family = "Helvetica", fontface = "bold")
figure <- figure + annotate("text", x = 0.165, y = 0.33, label = "Socioeconomic Factors:", 
                            color = "black", size = (7/.pt), family = "Helvetica", fontface = "bold")


# Save
ggsave("extended_data_fig_1.png",
       figure,
...
#Vector file:
ggsave(
  filename = "extended_data_fig_1.pdf",
  plot = figure,
  device = "pdf",
  width = 150,
  height = 160,
