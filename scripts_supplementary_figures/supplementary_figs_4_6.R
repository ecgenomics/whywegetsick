...
gc <- read.delim("longevity-genetic-correlations.txt", sep="\t")
names(gc)[1] <- c("Code")

# Load pleiotropies
pleio <- read.delim("longevity-commonSNPs-pleioFDR-conjfdr005-pleiotropies.csv", sep=",")
...
ggsave(
  filename = "supplementary_fig_4.pdf",
  plot = fig,
  device = "pdf",
  width = 180,
  height = 170,
...
ggsave(
  filename = "supplementary_fig_6.pdf",
  plot = fig2,
  device = "pdf",
  width = 180,
  height = 170,
