...
gc <- read.delim("../data/fertility-genetic-correlations.txt", sep="\t")
names(gc)[1] <- c("Code")
# Load pleiotropies
pleio <- read.delim("../data/fertility-commonSNPs-pleioFDR-conjfdr005-pleiotropies.list", sep=",")
...
ggsave2("./correlations_fertility_genetic_correlations.png",
...
ggsave2("./correlations_fertility_pleiotropies.png",
